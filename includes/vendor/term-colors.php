...
final class WP_Term_Colors extends WP_Term_Meta_UI {
	...
	public function __construct( $file = '' ) {
		...
		// Setup the labels
		$this->labels = array(
			'singular'    => esc_html__( 'Cor',  'wp-term-colors' ),
			'plural'      => esc_html__( 'Cores', 'wp-term-colors' ),
			'description' => esc_html__( 'Selecione uma cor para esta categoria.', 'wp-term-colors' )
		);
